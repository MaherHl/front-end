...
function Companylogin() {
   return (
     <div className='flex flex-row w-full'>
       <img src={require('../img/Company.jpg')} alt='' className='w-[60%] object-fill mt-20 mr-20  h-full' />
       <div className='mt-20 text-center'>
         ...
         <button className='bg-blue-500 font-semibold hover:scale-110 transition-all duration-300 text-white py-1 px-16 w-80  rounded-[23px]'>Login</button><br/>
         <span className='block mt-10 text-[roboto]'>Dont have an acount? <a href='#' className='text-orange-600 hover:text-orange-800 transition-all duration-300'> Sign up</a></span>
         <span className=' text-[roboto] '><a href='#' className='text-orange-600 hover:text-orange-800 transition-all duration-300'>Login as Freelancer</a></span>
       </div>
     </div>
   );
 }
